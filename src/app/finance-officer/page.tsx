...
const FinanceOfficerDashboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const programs: ProgramWithStudents[] = Object.keys(mockPrograms).map(
        (programName) => {
      ...
      setStats({
        ...
        stipendNotReceived: mockStudents.filter((s) => !s.stipendReceived)
          .length,
      });
    }
  };
              ...
              <div className="p-6">
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-sm text-blue-800">
                    <strong>Note:</strong> The CSV file has been successfully
                    parsed into JSON format. Each row is converted to an object
                ...
                <div className="mt-4 flex justify-center">
                  <button
                    onClick={() =>
                      console.log(
                        "Ready to send JSON to backend (API coming soon)"
                      )
                    }
          ...
          {displayedPrograms.map((program) => (
            ...
            >
              ...
              <div
                className="bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 cursor-pointer transition-all border-b-2 border-blue-200 px-6 py-4"
                onClick={() =>
                  !selectedProgram && handleProgramClick(program.programName)
                }
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
